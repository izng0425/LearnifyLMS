...
export default function InstructorCreateClassroom() {
  ...
  useEffect(() => {
    ...
    async function fetchCourseData() {
      try {
        ...
        const sRes = await fetch(`http://localhost:5050/courses/${courses}/students/unassigned`);
        if (sRes.ok) {
    ...
    <div className="flex min-h-screen justify-center p-6">
      <main className="w-full max-w-4xl">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={() => navigate("/instructor-classroom")}
