...
/**
 * InstructorLessonsSample
 * - Sample list of existing lessons (for demo).
 * - Cards show: ID, Title, Owner. Includes Edit (pencil) + Open buttons (visual only).
 */
export default function InstructorLessonsSample() {
  const existing = [
  ...
  return (
    <main className="mx-auto max-w-5xl px-4 py-8">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold tracking-tight text-teal-800">Existing lessons (Sample)</h1>
          ...
          <div key={l.id} className="rounded-xl border border-teal-200 bg-white p-4 shadow-sm">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center gap-2">
                {/* Edit (pencil) → link to EditLessons */}
