// src/pages/InstructorClassroom.jsx
...
export default function InstructorClassroom() {
  const instructorMenu = [
    ...
    { path: "/instructor-manage-classroom", label: "Manage Classroom", icon: ClassroomIcon },
  ];
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      const res = await fetch(
        `http://localhost:5050/classrooms/${deleteTarget._id}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
    ...
    <div className="flex">
      ...
      <main className="flex-1 mx-auto max-w-5xl px-4 py-8">
        <div className="flex items-center justify-between">
          ...
          <Link to="/instructor-create-classroom">
            <button
              type="button"
                  ...
                  return (
                    ...
                    >
                      <h2 className="text-lg font-semibold">
                        <Link
                          to="/instructor-view-classroom"
                          state={{ classroom: room, backTo: "/instructor-classroom" }}
                      ...
                      {/* Buttons: View Details + Enter Classroom */}
